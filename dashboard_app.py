...
body{background:#f5f7fb}.feature-panel,.band,.footer{background:#f5f7fb}.feature-grid,.pricing .price{box-shadow:0 12px 34px rgba(17,24,39,.04);border-color:#e7ebf2}.flow-strip{background:#111827}.cta{background:#111827;box-shadow:0 18px 50px rgba(17,24,39,.10)}.btn{border-color:#e2e8f0;box-shadow:0 8px 18px rgba(15,23,42,.06)}.btn.primary{background:#ef4444;border-color:#ef4444}.hero-topbar{height:68px;background:rgba(255,250,243,.90);box-shadow:0 10px 30px rgba(151,79,18,.06)}.hero-nav-inner{width:min(1320px,calc(100vw - 40px))}.hero-brand{gap:10px;font-size:20px}.hero-brand img{width:42px;height:42px;object-fit:contain;border-radius:12px;background:#fff;box-shadow:0 8px 18px rgba(151,79,18,.10)}.hero-nav a.active:after{bottom:-10px}.nav-auth{height:36px;min-width:112px;padding:0 16px}.hero-image>img{height:100vh;min-height:760px;transform:none;margin-bottom:0;object-position:center top}@media(max-width:1280px){.hero-topbar{height:64px}.hero-brand img{width:38px;height:38px}}@media(max-width:900px){.hero-image>img{height:auto;min-height:0;transform:none;margin-bottom:0}.hero-topbar{height:60px}.hero-brand img{width:36px;height:36px}}</style>
</head>
<body>
