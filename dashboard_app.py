...
body{background:#f5f7fb}.feature-panel,.band,.footer{background:#f5f7fb}.feature-grid,.pricing .price{box-shadow:0 12px 34px rgba(17,24,39,.04);border-color:#e7ebf2}.flow-strip{background:#111827}.cta{background:#111827;box-shadow:0 18px 50px rgba(17,24,39,.10)}.btn{border-color:#e2e8f0;box-shadow:0 8px 18px rgba(15,23,42,.06)}.btn.primary{background:#ef4444;border-color:#ef4444}</style>
</head>
<body>
