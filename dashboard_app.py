...
*{box-sizing:border-box}html{scroll-behavior:smooth}body{margin:0;font:14px/1.65 "Microsoft YaHei UI",Segoe UI,system-ui,sans-serif;color:var(--ink);background:#fffaf3}a{text-decoration:none;color:inherit}.hero-image{position:relative;width:100%;min-height:100vh;background:#fff4e6;overflow:hidden}.hero-image img{width:100%;height:100vh;min-height:760px;object-fit:cover;object-position:center top;display:block}.hotspot{position:absolute;z-index:4;border-radius:999px;text-indent:-9999px;overflow:hidden;transition:background .16s ease,box-shadow .16s ease}.hotspot:hover{background:rgba(255,255,255,.18);box-shadow:0 0 0 2px rgba(239,47,34,.22) inset}.hs-home{left:38.5%;top:5.2%;width:5.2%;height:5.2%}.hs-features{left:44.7%;top:5.2%;width:5.2%;height:5.2%}.hs-strategy{left:51.0%;top:5.2%;width:5.2%;height:5.2%}.hs-price{left:57.4%;top:5.2%;width:5.2%;height:5.2%}.hs-help{left:63.7%;top:5.2%;width:5.2%;height:5.2%}.hs-about{left:69.8%;top:5.2%;width:7.3%;height:5.2%}.hs-login{left:85.9%;top:4.1%;width:9.8%;height:6.4%}.auth-pill{position:absolute;right:7.2%;top:3.7%;z-index:8;min-width:150px;height:7%;min-height:48px;padding:0 28px;border-radius:999px;display:flex;align-items:center;justify-content:center;background:linear-gradient(135deg,#ffe2b5,#d79d58);border:1px solid rgba(255,255,255,.72);box-shadow:0 18px 42px rgba(151,79,18,.20);color:#6a3d13;font-size:clamp(16px,1.35vw,24px);font-weight:950;letter-spacing:.02em}.auth-pill:hover{filter:brightness(1.04);transform:translateY(-1px)}.hs-cta{left:18.5%;top:73.2%;width:18.2%;height:8.6%;border-radius:34px}.mobile-actions{display:none}.btn{height:46px;border:1px solid rgba(217,154,54,.32);border-radius:14px;background:rgba(255,255,255,.92);padding:0 20px;display:inline-flex;align-items:center;font-weight:950;box-shadow:0 16px 36px rgba(151,79,18,.10)}.btn.primary{background:linear-gradient(135deg,var(--red),var(--red2));color:#fff;border-color:var(--red);box-shadow:0 18px 42px rgba(239,47,34,.24)}.band{width:min(1180px,calc(100vw - 44px));margin:0 auto;padding:48px 0}.section-title{font-size:32px;line-height:1.15;margin:0 0 8px}.section-sub{color:var(--muted);margin:0 0 20px}.cards{display:grid;grid-template-columns:repeat(3,1fr);gap:14px}.card{background:#fff;border:1px solid var(--line);border-radius:16px;padding:20px;box-shadow:0 16px 42px rgba(151,79,18,.07)}.card h3{margin:0 0 8px}.card p{color:#5f4c3b;margin:0}.showcase{width:min(1180px,calc(100vw - 44px));margin:0 auto 42px;padding:18px;background:linear-gradient(135deg,#fff,#fff7ec);border:1px solid rgba(217,154,54,.20);border-radius:26px;box-shadow:0 24px 70px rgba(151,79,18,.10);display:grid;grid-template-columns:1.08fr .92fr;gap:18px;align-items:stretch}.showcase-main{min-height:520px}.showcase img{width:100%;height:100%;object-fit:contain;border-radius:18px;display:block;background:#fff8ee}.showcase-side{display:grid;gap:14px}.showcase-side img{min-height:252px}.pricing{display:grid;grid-template-columns:repeat(3,1fr);gap:14px}.price{background:#fff;border:1px solid var(--line);border-radius:18px;padding:22px}.price.featured{border-color:var(--red);box-shadow:0 20px 55px rgba(239,47,34,.13)}.money{font-size:34px;font-weight:950;margin:8px 0}.list{padding:0;margin:12px 0 0;list-style:none}.list li{padding:6px 0;color:#5f4c3b}.cta{margin:20px auto 0;width:min(1180px,calc(100vw - 44px));background:linear-gradient(135deg,#2b170f,#6b2b13);color:#fff;border-radius:18px;padding:30px;display:flex;align-items:center;justify-content:space-between;gap:16px}.cta h2{margin:0;font-size:30px}.cta p{margin:4px 0 0;color:#ead7c5}.footer{width:min(1180px,calc(100vw - 44px));margin:0 auto;padding:28px 0 40px;color:#7a6658}@media(max-width:900px){.hero-image img{height:auto;min-height:0;object-fit:contain}.hotspot,.auth-pill{display:none}.mobile-actions{display:flex;gap:10px;flex-wrap:wrap;padding:14px 16px 24px;background:#fff4e6}.cards,.pricing,.showcase{grid-template-columns:1fr}.showcase-main{min-height:0}.showcase-side img{min-height:0}.cta{display:block}.section-title{font-size:26px}}
</style>
</head>
<body>
...
<section class="showcase">
  <div class="showcase-main"><img src="/assets/home-detail.png" alt="做T神器盘中辅助详情"></div>
  <div class="showcase-side">
    <img src="/assets/home-capability.png" alt="做T神器核心能力">
    <div class="card"><h3>从信号到复盘</h3><p>首页只展示核心卖点，复杂功能放进控制台。用户先理解价值，再进入监控、模拟、选股和自定义策略。</p></div>
  </div>
</section>
